...
merged_df.drop(columns=["Department", "Object Name", "Title", "Object Begin Date", "Object End Date", "Medium", "Dimensions", "Century_binary"], inplace=True)
...
for name, rpt in zip(names, classification_results):
    print(f"Model: {name}")
    print(rpt)
